...
<head>
    ...
    <style>
        ...
        /* ≡ƒÜÇ Sidebar Navigation Box Styles (Kotak-kotak) */
        .sidebar .nav-item {
        ...
        /* ≡ƒöä Dinamis: Teks muncul saat EXPAND, Ikon muncul saat MINIMIZE */
        ...
        /* Γåö∩╕Å Saat Sidebar Diciutkan (Minimized / Toggled) */
        ...
        /* ≡ƒû╝∩╕Å Logo Adjustment (Maximize/Minimize) */
        ...
        @if (!request()->has('embed'))
            <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                @if (strtolower(Auth::user()->role) === 'administrator')
                    ...
                    {{-- 10. MINUTES OF MEETING (MoM) ΓÇö Administrator: rekap semua divisi, read-only --}}
                ...
                {{-- ≡ƒÜÇ SIDEBAR KHUSUS OPERASIONAL (RAFI) ≡ƒÜÇ --}}
                ...
                @if ($userRole === 'administrator' || in_array($userName, ['Linda', 'Yasmin', 'Agus Setyo']))
                    ...
                    {{-- Minutes of Meeting (MoM) ΓÇö untuk Linda, Yasmin, dan Agus Setyo --}}
                ...
                {{-- Menu MoM ΓÇö semua role internal kecuali administrator (sudah ada di blok khusus administrator),
                            ...
                            <div class="topbar-marquee-container d-none d-md-flex">
                                <div class="topbar-marquee-text">
                                    @if (request()->routeIs('admin.dailyactivity.*') || request()->is('admin/dailyactivity*'))
                                        ≡ƒô¥ JANGAN LUPA MENGISI DAILY ACTIVITY SETIAP JAM 15.00 , SEMANGAT... ≡ƒÆ¬
                                    @else
                                        Γ£¿ SELAMAT DATANG DI HELAS CORP. SELAMAT BEKERJA, Γ£¿
                                    @endif
                                </div>
                            </div>
                        @endif
