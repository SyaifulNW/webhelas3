...
class MarketingParticipantController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Calculate Stats from the already filtered $participants collection
    $totalMarketingDatabase = $participants->count();
    $transferredCount = $participants->where('is_transferred', true)->count();
    $untransferredCount = $participants->where('is_transferred', false)->count();

    // Group transferred participants by their assigned CS
    $transferredGroups = $participants->where('is_transferred', true)
        ->groupBy('assigned_cs');
