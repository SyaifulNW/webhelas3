                    ...
                    <tbody>
                        ...
                        @php 
                            ...
                            $allMbcClasses = collect($scheduledClassNames)
                                ...
                                ->unique()
                                ->filter(fn($name) => $name !== 'Start-Up Muslim Indonesia' && $name !== 'Scale Up Muslim Institute');
                        @endphp
                        ...
                        <tr data-category="Pendapatan SMI" class="row-pendapatan border-top">
                            ...
                            <td class="px-3">
                                <div class="font-weight-bold text-dark">Pendapatan SMI</div>
                                <div class="small text-muted">Input manual data SMI</div>
                            </td>
                            ...
                            <td class="sub-row-indicator">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span>
                                        ...
                                        <span class="text-muted">Pendaftaran SMI</span>
                            ...
                            <td class="sub-row-indicator">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span>
                                        ...
                                        <span class="text-muted">SPP SMI</span>
                        ...
                        <tr class="row-pendapatan-sub sub-Pendapatan-SMI" style="font-size: 0.85rem; background-color: #fafafa;">
                            ...
                            <td class="sub-row-indicator">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span>
                                        <span class="item-letter">c.</span>
                                        <span class="text-muted">Tunggakan SPP</span>
                                        <a href="{{ route('peserta-smi.index', ['filter_year' => $selectedYear, 'filter_spp_month' => (int)$selectedMonth, 'filter_spp_status' => '0']) }}" class="ml-1 text-danger small" title="Lihat Data">
                                            <i class="fas fa-external-link-alt" style="font-size: 0.7rem;"></i>
                                        </a>
                                    </span>
                                    <div class="ml-auto">
                                        <input type="text" 
                                               class="nominal-input-ghost text-danger laba-rugi-auto-save rupiah-format" 
                                               data-type="pendapatan" 
                                               data-keterangan="Tunggakan SPP" 
                                               value="{{ number_format($totalSmiTunggakan, 0, ',', '.') }}"
                                               {{ !$canEdit ? 'readonly' : '' }}>
                                    </div>
                                </div>
                            </td>
                            <td class="px-2"></td>
                            <td class="text-center text-muted" style="font-size: 0.75rem;">
                                {{ $calcTotalPendapatan > 0 ? number_format(($totalSmiTunggakan / $calcTotalPendapatan) * 100, 1) . '%' : '0%' }}
                            </td>
                            @if(strtolower(Auth::user()->role) !== 'administrator')
                            <td></td>
                            @endif
