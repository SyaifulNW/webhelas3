        ...
        <table>
            ...
            <tbody>
                ...
                <tr class="sub-item">
                    <td></td>
                    <td></td>
                    <td style="padding-left: 30px;">c. Tunggakan SPP</td>
                    <td class="nominal text-danger">{{ number_format($totalSmiTunggakan, 0, ',', '.') }}</td>
                    <td class="text-center" style="font-size: 8px;">{{ $calcTotalPendapatan > 0 ? number_format(($totalSmiTunggakan / $calcTotalPendapatan) * 100, 1) . '%' : '0%' }}</td>
                </tr>
