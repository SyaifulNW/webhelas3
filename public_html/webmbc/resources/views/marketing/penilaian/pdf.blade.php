...
<head>
    ...
    <style>
        ...
        .main-table th { background-color: #fbbc04; color: #000; }
        .total-row { background-color: #d1f7d6; font-weight: bold; }
        .footer { margin-top: 50px; text-align: right; }
        .footer .signature { margin-top: 60px; border-top: 1px solid #333; display: inline-block; width: 200px; text-align: center; }
...
<body>
    ...
    <table class="main-table">
        ...
        <tbody>
            ...
            @else
                ...
                <tr>
                    <td class="center">2</td>
                    <td>Leads SMI (Start-Up Muslim Indonesia)</td>
    ...
    <div style="margin-top: 20px; text-align: center; padding: 15px; border-radius: 8px; font-weight: bold; color: white; background-color: {{ $totalNilai < 70 ? '#dc3545' : '#28a745' }}">
