...
class PesertaSmiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax() || $request->has('ajax')) {
            $html = view('admin.Sales.peserta-smi.table-rows', compact('data', 'monthsRaw'))->render();
            $monthSpp = $sppMonth;
            $yearSpp = $yearFilter;
        ...
        return view('admin.Sales.peserta-smi.index', [
            'data' => $data,
            'listCs' => $listCs,
            'csList' => $csList,
            'kelasList' => $kelasList,
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('admin.Sales.peserta-smi.pdf', compact('data', 'monthsRaw', 'pdfTitle', 'sppMonth', 'yearFilter', 'stats'));
