...
class KasKecilController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.Finance.keuangan.kas_kecil', compact('kasPusat', 'kasAesthetic', 'bulan', 'tahun', 'saldoAwalPusat', 'saldoAwalAesthetic', 'kategori'));
    }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('admin.Finance.keuangan.kas_kecil_pdf', compact('kas', 'bulan', 'tahun', 'saldoAwal', 'kategori'));
