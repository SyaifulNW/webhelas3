...
<div class="container-fluid px-4 py-3">
    ...
    @elseif(request('section') == 'absensi')
        ...
        <h4 class="font-weight-bold text-dark mb-4"><i class="fas fa-calendar-check text-info mr-2"></i> Absensi & Izin Karyawan</h4>

        <div class="row g-4 mb-4">
            <div class="col-md-4">
                <div class="card widget-card shadow-sm p-4 text-center">
                    <h6 class="text-muted font-weight-bold">Hadir Hari Ini</h6>
                    <h2 class="text-info font-weight-bold mb-0">95%</h2>
                    <small class="text-success mt-1"><i class="fas fa-arrow-up mr-1"></i> +2% vs Kemarin</small>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card widget-card shadow-sm p-4 text-center">
                    <h6 class="text-muted font-weight-bold">Terlambat</h6>
                    <h2 class="text-warning font-weight-bold mb-0">2%</h2>
                    <small class="text-muted mt-1">Sanksi & Teguran otomatis</small>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card widget-card shadow-sm p-4 text-center">
                    <h6 class="text-muted font-weight-bold">Cuti / Izin</h6>
                    <h2 class="text-danger font-weight-bold mb-0">3%</h2>
                    <small class="text-muted mt-1">1 Karyawan Cuti Tahunan</small>
                </div>
            </div>
        </div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td class="py-3 px-4 font-weight-bold">Fitra Jaya Saleh</td>
                                <td>07:55 WIB</td>
                                <td>17:05 WIB</td>
                                <td><span class="badge bg-aktif premium-badge">Tepat Waktu</span></td>
                                <td>Office / 192.168.1.10</td>
                            </tr>
                            <tr>
                                <td class="py-3 px-4 font-weight-bold">Linda</td>
                                <td>08:00 WIB</td>
                                <td>17:02 WIB</td>
                                <td><span class="badge bg-aktif premium-badge">Tepat Waktu</span></td>
                                <td>Office / 192.168.1.11</td>
                            </tr>
                            <tr>
                                <td class="py-3 px-4 font-weight-bold">Yasmin</td>
                                <td>08:12 WIB</td>
                                <td>17:15 WIB</td>
                                <td><span class="badge bg-cuti premium-badge">Terlambat 12m</span></td>
                                <td>WFH / 36.85.12.98</td>
                            </tr>
                            <tr>
                                <td class="py-3 px-4 font-weight-bold">Maria</td>
                                <td>07:58 WIB</td>
                                <td>17:00 WIB</td>
                                <td><span class="badge bg-aktif premium-badge">Tepat Waktu</span></td>
                                <td>Office / 192.168.1.15</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
