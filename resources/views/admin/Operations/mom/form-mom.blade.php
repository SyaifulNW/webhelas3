        ...
        @if (session('success'))
            <div class="form-header-card" style="padding: 30px 24px; text-align: left;">
                ...
                <div style="border-top: 1px solid #dadce0; padding-top: 16px; display: flex; flex-direction: column; gap: 12px; align-items: flex-start;">
                    <a href="{{ route('admin.mom.create', ['username' => \Illuminate\Support\Str::slug(Auth::user()->name)]) }}" style="color: #673ab7; font-size: 14px; text-decoration: none; font-weight: 500; cursor: pointer;">
                        Kirim jawaban lain
                    </a>
