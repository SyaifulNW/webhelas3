...
>>>>>>> Stashed changes
    ...
    <script>
        ...
        function filterByStat(type) {
            ...
            // Table 1 (membership stats) filters: set month and year to current month & year instead of 'all'
            if (['all', 'aktif', 'cuti', 'lunas', 'pending'].includes(type)) {
                if (sppMonthSelect) sppMonthSelect.value = defaultActiveMonth;
                if (yearSelect) yearSelect.value = "{{ date('Y') }}";
